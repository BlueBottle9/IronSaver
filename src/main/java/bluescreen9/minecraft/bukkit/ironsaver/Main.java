...
public class Main extends JavaPlugin{
	...
	protected static FileConfiguration Config;
				...
				public void onEnable() {
					...
					if (Config.getBoolean("auto.back-up.enable")) {
						new BukkitRunnable() {
							@Override
							public void run() {
						...
						}.runTaskTimerAsynchronously(IronSaver, Config.getLong("auto-back-up.timer") * 20, Config.getLong("auto-back-up.timer") * 20);
					}
				}
